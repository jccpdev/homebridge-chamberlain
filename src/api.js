...
module.exports = class {
    ...
    getAccountId(options = {}) {
        ...
        return this.getSecurityToken(options).then(SecurityToken => req({
            method: "GET",
            pathname: "/api/v5/My",
            query: {
                expand: "account"
    ...
    getDeviceList(options = {}) {
        ...
        return this.getSecurityToken(options).then(SecurityToken => this.getAccountId(options).then(AccountId => req({
            method: "GET",
    ...
    getDeviceId(options = {}) {
        ...
        return this.getDeviceList(options).then(devices => {
            const withoutGateways = _.reject(devices, {
                device_type: "hub"
            });
    ...
    getSecurityTokenAccountIdAndMyQDeviceId(options = {}) {
        return this.maybeRetry(() => this.getSecurityToken(options).then(SecurityToken => this.getAccountId(options).then(AccountId => this.getDeviceId(options).then(MyQDeviceId => ({
            SecurityToken,
            AccountId,
            MyQDeviceId
        })))));
    ...
    getDeviceAttribute(options = {}) {
        ...
        return this.maybeRetry(() => this.getSecurityTokenAccountIdAndMyQDeviceId(options).then(({
            SecurityToken,
            AccountId,
            MyQDeviceId
        }) => req({
